...
if($marka=="e95"){$site="http://www.gudriem.lv/degviela?lng=lv&ci=&st=&t=&fc=&o=1";}
elseif($marka=="e98"){$site="http://www.gudriem.lv/degviela?lng=lv&ci=&st=&t=&fc=&o=5";}
elseif($marka=="dd"){$site="http://www.gudriem.lv/degviela?lng=lv&ci=&st=&t=&fc=&o=9";}
else {$site="http://www.gudriem.lv/degviela?lng=lv&ci=&st=&t=&fc=&o=1";}

if($station=="all stations"){$stationID="";}
elseif($station=="lukoil"){$stationID=1;}
elseif($station=="dinaz"){$stationID=2;}
elseif($station=="statoil"){$stationID=3;}
elseif($station=="trest"){$stationID=6;}
elseif($station=="neste"){$stationID=4;}
elseif($station=="viada"){$stationID=5;}
elseif($station=="virši-a"){$stationID=9;}
else{$stationID="";}


$site=$site."&co=".$stationID;
  ...
  function codeAddress(address,markerNr,e95,e98,dd,nosaukums) {  
    geocoder.geocode( { 'address': address}, function(results, status) {//the address has been passed as street name and number and
      if (status == google.maps.GeocoderStatus.OK) {	    			//it should be geocoded through geocoder.
		  ...
		  if ($marka=="e95"){echo "icon: 'icons/gas95_";}
		  elseif($marka=="e98"){echo "icon: 'icons/gas98_";}
		  elseif($marka=="dd"){echo"icon: 'icons/gasdd_";}
